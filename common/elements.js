...
const smoke = new Element("Smoke", 10, "rgb(120, 120, 120)", 0.0008, 21, 80, 300, false, 0.01, false, false);

const elements = { powder, water, oxygen, stone, oil, ice, steam, lava, wood, fire, smoke };
